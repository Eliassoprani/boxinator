...
namespace backend.Controllers
{
    public static class AuthApi
    {
        ...
        public static async Task<IResult> Login(UserManager<User> userManager, TokenService tokenService, LoginPayload payload)
        {
        ...
        public static async Task<IResult> Register(UserManager<User> userManager, RegisterPayload payload)
        {
        ...
        public static async Task<IResult> deleteUserById(UserManager<User> userManager, string id) {
